...
nombre_completo1 = str(input("ingrese el nombre completo del papa"))
nombre_completo2 = str(input("ingrese su nombre completo de la mama"))
nombre = str(input("ingrese su el nombre completo del hijo/a"))
nombre_completo1.split(" ") 
nombre1 = nombre_completo1[0:1]
